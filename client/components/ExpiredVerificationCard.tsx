...
const StatusBadge = () => {
  return (
    <div className="flex h-5 px-2 justify-center items-center gap-1 rounded-[20px] bg-[#ECB7BF]">
      <div className="w-2 h-2 rounded-full flex-shrink-0 bg-[#D83A52]" />
      <span className="font-roboto text-[13px] font-normal leading-5 text-[#49290E]">
        Expired
      </span>
    </div>
  );
